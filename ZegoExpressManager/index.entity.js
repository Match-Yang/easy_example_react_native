...
exports.ZegoVideoViewType =
  exports.ZegoStreamQualityLevel =
  exports.ZegoDeviceUpdateType =
  exports.ZegoMediaOptions =
    void 0;
...
(function (ZegoMediaOptions) {
  ...
  ZegoMediaOptions[(ZegoMediaOptions.PublishLocalAudio = 4)] =
    'PublishLocalAudio';
  ZegoMediaOptions[(ZegoMediaOptions.PublishLocalVideo = 8)] =
    'PublishLocalVideo';
})(
  (ZegoMediaOptions =
    exports.ZegoMediaOptions || (exports.ZegoMediaOptions = {})),
);
...
(function (ZegoDeviceUpdateType) {
  ...
  (ZegoDeviceUpdateType =
    exports.ZegoDeviceUpdateType || (exports.ZegoDeviceUpdateType = {})),
);
...
(function (ZegoStreamQualityLevel) {
  ...
  (ZegoStreamQualityLevel =
    exports.ZegoStreamQualityLevel || (exports.ZegoStreamQualityLevel = {})),
);
...
(function (ZegoVideoViewType) {
  ...
  (ZegoVideoViewType =
    exports.ZegoVideoViewType || (exports.ZegoVideoViewType = {})),
);
