...
var ZegoExpressManager = /** @class */ (function () {
        ...
        return zego_express_engine_reactnative_1["default"].instance()
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        _a.sent();
                        console.warn('[ZEGOCLOUD LOG][Manager][enableCamera] - Enable success', this.localParticipant.camera);
                        console.warn('[ZEGOCLOUD LOG][Manager][muteMicrophone] - Mute success', !this.localParticipant.mic);
                        _a.label = 4;
    ...
    ZegoExpressManager.prototype.enableMic = function (enable) {
        ...
        return zego_express_engine_reactnative_1["default"].instance()
            ...
            .then(function () {
            console.warn('[ZEGOCLOUD LOG][Manager][muteMicrophone] - Enable success', !enable);
        });
    };
    ZegoExpressManager.prototype.enableSpeaker = function (enable) {
        ...
        return zego_express_engine_reactnative_1["default"].instance().muteSpeaker(!enable).then(function () {
            console.warn('[ZEGOCLOUD LOG][Manager][muteSpeaker] - Enable success', !enable);
        });
    };
    ...
    ZegoExpressManager.prototype.setLocalVideoView = function (renderView) {
        ...
        zego_express_engine_reactnative_1["default"].instance()
            ...
            .then(function () {
            console.warn('[ZEGOCLOUD LOG][Manager][startPreview] - Preview success');
        });
    };
